<div class="container">
    ...
    <<<<<<< HEAD=======</div>
        ...
        >>>>>>> 90ff461ded7483c21d4fad0eb32e51c417f7c67a
        ...
        ?>
                    <<<<<<< HEAD <!-- <li><i class="fa-solid fa-carrot"></i><a href="">'.$name_cate.'</a><i
                            class="fa-solid fa-circle-chevron-right"></i></li>
                        <li><i class="fa-solid fa-carrot"></i><a href="">'.$name_cate.'</a><i
                                class="fa-solid fa-circle-chevron-right"></i></li>
                        <li><i class="fa-solid fa-carrot"></i><a href="">'.$name_cate.'</a><i
                                class="fa-solid fa-circle-chevron-right"></i></li>
                        <li><i class="fa-solid fa-carrot"></i><a href="">'.$name_cate.'</a><i
